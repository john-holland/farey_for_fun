...
import { WANOSServeServer } from './server/WANOSServeServer';
import { MockTelemetryService } from './mocks/MockTelemetryService';
import { MockROMRegistry } from './mocks/MockROMRegistry';
import { ServeConfig } from './types/ServeConfig';
import path from 'path';

// Create mock services
const mockTelemetry = new MockTelemetryService();
const mockROMRegistry = new MockROMRegistry();
...
async function main() {
  try {
    ...
    const server = new WANOSServeServer(serveConfig);
